...
public class CustomZoomView extends View {
     ...
     * 边角线长度
     */
    private float mCornerLength = 30f * mDensity;

    /**
     * 边角线偏移值
     */
    private float mCornerOffset = 5 * mDensity;
     ...
     * 是否绘制坐标点
     */
    private boolean mIsDrawPonit = true;
    /**
     * 是否绘制测绘线
     */
    ...
    private void initPaint() {
        ...
        /**设置画笔颜色*/
        mMappingLinePaint.setColor(ContextCompat.getColor(mContext, R.color.cardview_shadow_start_color));
